...
To enable kvm passthrough, add the following module options (including the comma separated vendor IDs identified in the prior step):
...
Update boot settings to enable IOMMU with pass-through mode:
