...
* learn computational reasoning and problem solving from a data science perspective
...
Yes, for example, someone may not have been able to get to the lifeboats because they were in a lower deck, which is correlated to third class. Also, children were disporptionately in third class, but they were also impacted by the "children first" protocal.
|===
