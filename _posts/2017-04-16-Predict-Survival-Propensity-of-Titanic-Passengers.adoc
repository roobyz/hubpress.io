...
Some attributes are correlated: when they vary other attributes will also vary to some degree. Machine learning leverages that interdependence to model the predicted outcomes. For accurate model performance, we need to:
