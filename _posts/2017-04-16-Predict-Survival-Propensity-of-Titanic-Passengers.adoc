...
Yes, for example, someone may not have been able to get to the lifeboats because they were in a lower deck, which is correlated to class. To achieve reasonably accurate survival predictions, the model that we create will assign different weights to the variables of importance.
|===
