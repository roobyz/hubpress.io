...
Some variables are correlated with each other. When those attributes vary, the correlated attributes will also vary to some degree. Before training the model, we need to:
