...
Another cool feature of PVE is cloning. We can get our existing Windows VM and clone it to have alternate installation to experiment with. For example, maybe we want to install some experimental software or make hardware changes without risking our standard VM.
