...
In addition to a CPU and motherboard that supports IOMMU, you need two graphics cards (GPU):

. One GPU ProxMox (the host);
. One powerful GPU for your virtual machine guest (Windows, Linux).
