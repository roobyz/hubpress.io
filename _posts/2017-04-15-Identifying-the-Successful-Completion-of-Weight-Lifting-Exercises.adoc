...
= Qualitative Completion of Weight-Lifting Exercises
...
This machine learning exercise is "simple" in the sense that our data is well balanced across the class variables. This saves us from needing to account for that. However, there is ample opportunity to demonstrate the other major analytics steps required in most machine learning projects.
